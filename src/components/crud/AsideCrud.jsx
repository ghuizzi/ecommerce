  ...
  return (
    <div className="content">
        <div>
            ...
            <h4>Categories</h4><button onClick={()=> setAddModal(true)}>add</button>
            </div>
            
            <input type="checkbox" /> Lorem <div><button onClick={() => setEditModalMarc(true) }  className='btn'>edit</button><button  onClick={()  =>setDeleteModal(true) } className='btn'>delete</button></div>
            <input type="checkbox" /> Lorem <div><button className='btn'>edit</button><button className='btn'>delete</button></div>
            <input type="checkbox" /> Lorem <div><button className='btn'>edit</button><button className='btn'>delete</button></div>

        </div>
        <div >
            <h4>Marcs</h4><button onClick={()=> setAddModalMarc(true)}>add</button>
            <input type="checkbox" /> Lorem <div><button onClick={() => setEditModalMarc(true)} className='btn'>edit</button><button onClick={() => setDeleteMarc(true) } className='btn'>delete</button></div>
            <input type="checkbox" /> Lorem <div><button className='btn'>edit</button><button className='btn'>delete</button></div>
            <input type="checkbox" /> Lorem <div><button className='btn'>edit</button><button className='btn'>delete</button></div>
        </div>
        <div>
